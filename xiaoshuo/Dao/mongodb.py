...
class mongodb():
    def insert(self,XiaoshuoItem):
        db.book.insert(XiaoshuoItem)

    def biquge_insert(self, XiaoshuoItem):
         db.biquge.update({"book_url":XiaoshuoItem['book_url']},XiaoshuoItem,True)
